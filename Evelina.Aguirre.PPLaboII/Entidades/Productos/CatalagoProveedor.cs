...
{
    public class CatalagoProveedor
    {
        public static Dictionary<int, Producto> catalogo;
        private static string nombre;
        private static string cuil;
        static CatalagoProveedor()
        {
            catalogo = new Dictionary<int, Producto>();
            CargarCatalogo();
        }

        public CatalagoProveedor(string nombre, string cuil) 
        {
        }
        ...
        private static void CargarCatalogo()
        {
            ...
            Producto led1 = new Producto("Tira Led 15w", 1000, 100, "Perfil Aluminio 1 Metro Con luces Led 5630," +
            ...
            Producto led2 = new Producto("Tira Led 9w", 900, 101, "Perfil Aluminio 50 Cm C/36LED 5630, Directo A 220V Alta" +
            ...
            Producto led3 = new Producto("Led 1w", 3000, 102, "Led Blanco Frio Backlight 3030 3v 1w Centro Chico" +
                " X 100 U", ECategoriaElectronico.Leds);
            Producto led4 = new Producto("Led 1w", 1500, 103, "Led Blanco Frio Backlight 3528 3v 1w Tv LG " +
                "X 50 Unidades", ECategoriaElectronico.Leds);
            Producto led5 = new Producto("Led SMD 3030", 200, 104, "50 Unidades Led Smd 3030 6v 2w Pct Simetrico 3mm " +
                "X 3mm", ECategoriaElectronico.Leds);
            Producto led6 = new Producto("Led Cob 50w", 200, 105, "Led Cob 50w Blanco Frio 220v C/bornera 6000/6500k",
                ECategoriaElectronico.Leds);
            Producto led7 = new Producto("Tira LGB 5050", 300, 106, "Tira Luces Led Rgb 5050 Usb 2 M Decoracion Gamer Tv" +
                " Pc Strip", ECategoriaElectronico.Leds);
            Producto led8 = new Producto("Conector L", 100, 107, "Conector L Esquina Tiras Led 5050 Rgb Hebilla Sin Soldar" +
                " 90°", ECategoriaElectronico.Leds);
            Producto led9 = new Producto("Controladora RGB", 200, 108, "Controladora Para Tira Led Rgb 24 Teclas Control" +
                " Remoto 12v", ECategoriaElectronico.Leds);
            Producto led10 = new Producto("Controladora COB", 200, 109, "Controladora Para Tira Led Cob 24 Teclas Control" +
                " Remoto 12v", ECategoriaElectronico.Leds);
