...
namespace Entidades.Tienda
{
    public static class CatalogoProveedor
    {
        ...
        /// <summary>
        /// Carga la lista que contendrá el catálogo de productos que ofrece quien provee la tienda.
        /// </summary>
        public static void CargarCatalogo()
        {
            //Leds
            ComponentesElectronicos led1 = new ComponentesElectronicos("", 00, 0, 100, "", ECategoriaElectronico.Leds);
            ...
            //Bobinas
            ComponentesElectronicos bobina1 = new ComponentesElectronicos("", 00, 0, 110, "", ECategoriaElectronico.Bobinas);
            ...
            //Capacitores
            ComponentesElectronicos capacitor1 = new ComponentesElectronicos("", 00, 0, 120, "", ECategoriaElectronico.Capacitores);
            ...
            //Conectores
            ComponentesElectronicos conector1 = new ComponentesElectronicos("", 00, 0, 130, "", ECategoriaElectronico.Conectores);
            ...
            //Soldado
            Otros soldador1 = new Otros("", 00, 0, 1001, "", ECategoriasOtros.Soldado);
            Otros soldador2 = new Otros("", 00, 0, 1002, "", ECategoriasOtros.Soldado);
            Otros soldador3 = new Otros("", 00, 0, 1003, "", ECategoriasOtros.Soldado);
            Otros soldador4 = new Otros("", 00, 0, 1004, "", ECategoriasOtros.Soldado);
            Otros soldador5 = new Otros("", 00, 0, 1005, "", ECategoriasOtros.Soldado);

            //Limpieza
            Otros limpieza1 = new Otros("", 00, 0, 1010, "", ECategoriasOtros.Limpieza);
            Otros limpieza2 = new Otros("", 00, 0, 1011, "", ECategoriasOtros.Limpieza);
            Otros limpieza3 = new Otros("", 00, 0, 1012, "", ECategoriasOtros.Limpieza);
            Otros limpieza4 = new Otros("", 00, 0, 1013, "", ECategoriasOtros.Limpieza);
            Otros limpieza5 = new Otros("", 00, 0, 1014, "", ECategoriasOtros.Limpieza);
            Otros limpieza6 = new Otros("", 00, 0, 1015, "", ECategoriasOtros.Limpieza);
            Otros limpieza7 = new Otros("", 00, 0, 1016, "", ECategoriasOtros.Limpieza);
            Otros limpieza8 = new Otros("", 00, 0, 1017, "", ECategoriasOtros.Limpieza);
            Otros limpieza9 = new Otros("", 00, 0, 1018, "", ECategoriasOtros.Limpieza);
            Otros limpieza10 = new Otros("", 00, 0, 1019, "", ECategoriasOtros.Limpieza);

            //Herramientas
            Otros herramienta1 = new Otros("", 00, 0, 1020, "", ECategoriasOtros.Herramientas);
            Otros herramienta2 = new Otros("", 00, 0, 1021, "", ECategoriasOtros.Herramientas);
            Otros herramienta3 = new Otros("", 00, 0, 1022, "", ECategoriasOtros.Herramientas);
            Otros herramienta4 = new Otros("", 00, 0, 1023, "", ECategoriasOtros.Herramientas);
            Otros herramienta5 = new Otros("", 00, 0, 1024, "", ECategoriasOtros.Herramientas);
            Otros herramienta6 = new Otros("", 00, 0, 1025, "", ECategoriasOtros.Herramientas);
            Otros herramienta7 = new Otros("", 00, 0, 1026, "", ECategoriasOtros.Herramientas);
            Otros herramienta8 = new Otros("", 00, 0, 1027, "", ECategoriasOtros.Herramientas);
            Otros herramienta9 = new Otros("", 00, 0, 1028, "", ECategoriasOtros.Herramientas);
            Otros herramienta10 = new Otros("", 00, 0, 1029, "", ECategoriasOtros.Herramientas);

            //ControlTermico
            Otros controladorTermico1 = new Otros("", 00, 0, 1030, "", ECategoriasOtros.ControlTermico);
            Otros controladorTermico2 = new Otros("", 00, 0, 1031, "", ECategoriasOtros.ControlTermico);
            Otros controladorTermico3 = new Otros("", 00, 0, 1032, "", ECategoriasOtros.ControlTermico);
            Otros controladorTermico4 = new Otros("", 00, 0, 1033, "", ECategoriasOtros.ControlTermico);
            Otros controladorTermico5 = new Otros("", 00, 0, 1034, "", ECategoriasOtros.ControlTermico);
